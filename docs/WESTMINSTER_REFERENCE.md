...
**Compiled:** 4 September 2026. **Fact-check pass:** 4–5 September 2026 — an adversarial pass re-verified the platform numbering and directions (TfL Arrivals feed, OpenStreetMap), the Jubilee stacking (Wikipedia, OSM levels), the rolling-stock dimensions (Wikipedia infoboxes), the Westminster Quarters (Wikipedia), Big Ben/Portcullis House/JLE dates, the Achiampong roundel date and the 2026 bus routes (TfL API); corrections are marked in place and unresolved items were appended to §14 (#35–#40). Research sources are cited inline in abbreviated form (describe-online = Terry Robinson's 2005/2008 accessibility survey of the station, mirrored at mindspace.fi; ISSMGE 1996 = Carter, Bailey & Dawson, *Jubilee Line extension, Westminster Station design*, Balkema 1996; TfL API = api.tfl.gov.uk StopPoint 940GZZLUWSM; OSM = OpenStreetMap via Overpass).
...
| 20 Nov 1999 | Final JLE phase opens to Green Park; Jubilee trains run through Westminster non-stop. | [verified] |
| **22 Dec 1999** | Jubilee platforms open — the last JLE station to open, 131 years after the original. (The JLE's platform-edge doors were the first on a commercial railway in Great Britain, but they had been in public use since the first phase, Stratford–North Greenwich, opened on 14 May 1999 — Westminster's were simply the last set to open.) | [verified] |
...
| 2017–22 | Elizabeth Tower restoration; regular chiming resumed 13 Nov 2022 (Remembrance Sunday — it had struck ceremonially for Armistice Day two days earlier). | [verified] |
| 2022 | Larry Achiampong's permanent roundel *Pan African Flag for the Relic Travellers' Alliance (Union)* installed (Art on the Underground commission developed 2019–20). Mark Wallinger's *Labyrinth* enamel panel (2013, network-wide) also present. | [verified] |
...
Westminster Underground Station, Bridge Street, London SW1A 2JR, Zone 1. Lines: Circle, District, Jubilee. Station centroid 51.50132 N, 0.124861 W. **17 escalators, 5 lifts, 1 ticket hall, 15 ticket gates, 4 payphones, 4 cash machines (Euro-capable), WiFi yes, toilets no (inside the gateline — public toilets exist in the Whitehall subway, see §2.5), waiting room no, photo booths 0, boarding ramps 'yes — Circle and District lines only', help points listed as 0 (a data quirk; help points exist, see §12.9), 'subway to street, routeways platform to ticket hall'.** API platform child points (re-queried 4 Sep 2026 — note the StopPoint children carry NO platform numbers, only line names, so any 'Platform 1 = the first-listed point' reading is an assumption): two Circle/District points at 51.501284, −0.124877 and 51.501185, −0.124838, and two Jubilee points at 51.501004, −0.124773 and 51.501006, −0.124932 — the Jubilee pair sit at the same latitude 11 m apart E–W, c. 6 m south of the entrance, i.e. under the Bridge Street pavement/carriageway, exactly as stacked tunnels along the box's south wall should. The live Arrivals feed does label the Jubilee platforms: **'Eastbound - Platform 3'** (to Stratford) and **'Westbound - Platform 4'** (to Stanmore) `[verified 4 Sep 2026]`. Passenger numbers c. 20 million a year `[estimate]`.
...
**D. OSM subway_entrance nodes** `[verified]`: 587959213 (51.5011521, −0.1237400) ref=1, wheelchair=yes; 12793161797 (51.5011543, −0.1237871) ref=2 — 3 m apart at the NE corner; 1587633281 (51.5012268, −0.1259759) and 1587633283 (51.5012427, −0.1264302) 'Steps down and in subway' on Parliament Street (31 m apart); 2621668682 (51.5007807, −0.1242229) south side east, steps; 10671686470 (51.5010615, −0.1248863) wheelchair=yes, the main ticket-hall/lift entrance. Net: five street staircases plus one step-free route. (Re-queried via Overpass 4 Sep 2026: unchanged — refs exist only on the two Embankment-corner nodes; the four other stair nodes are tagged wheelchair=no.)
...
| 4 | **Jubilee eastbound Platform 3** (upper tunnel; OSM way 162514000 ref=3 name=Eastbound level −4; TfL Arrivals 'Eastbound - Platform 3') | **c. −22 to −24 m** | [estimate] depth; [verified] number/direction |
...
- O&K heavy-duty JLE escalators, standard LU geometry: **30° incline, 1,000 mm step width, 0.75 m/s** (some LU units run at 0.65 m/s), **tread depth 400 mm, rise c. 230 mm** (400 mm × tan 30° = 231 mm — a 210 mm rise would imply a 27.7° incline) `[verified]` speed/geometry.
...
- **Platform 3 = eastbound (upper), Platform 4 = westbound (lower).** Photographed signs: 'Jubilee line ↑ Eastbound platform 3', 'Jubilee line ↓ Westbound platform 4'; live boards list 'Platform 4' for Stanmore trains; Beauty of Transport confirms eastbound above westbound. (The audio researcher's '3 westbound upper, 4 eastbound lower' was explicitly a guess and is superseded.) Independently confirmed 4 Sep 2026: the TfL Arrivals feed labels them 'Eastbound - Platform 3' / 'Westbound - Platform 4'; Wikipedia: 'the two Jubilee line platform tunnels are arranged with the westbound platform below the eastbound'; OSM ways 162514000 (ref 3, Eastbound, level −4) and 162514001 (ref 4, Westbound, level −5), both noted 'stacked, actually on top of each other'.
...
- **Signage researcher** `[inferred — now shown to be unfounded]`: Platform 1 = eastbound on the north track, Platform 2 = westbound on the south track, inferred from the TfL API platform coordinates plus left-hand running. Re-checking the API (4 Sep 2026) shows the StopPoint platform children are **unlabelled** — the point at 51.501284, −0.124877 is merely listed first; nothing in the API calls it 'Platform 1'.
- **OpenStreetMap** `[verified 4 Sep 2026]`: platform way 162514002 ref=**1** name=**Westbound** ('Circle and District Lines', level −2) and way 162514003 ref=**2** name=**Eastbound**; the westbound way's centroid (51.501367, −0.124773) lies c. 7 m south and 5 m east of the eastbound's (51.50143, −0.124851), i.e. on the SE/Bridge Street side.
- **Rolling-stock researcher:** explicitly an estimate.

**Verdict: Platform 1 = WESTBOUND, Platform 2 = EASTBOUND.** Reasons: (1) it is the only version backed by a photographed sign and a walking survey, and OSM's platform refs/names agree; (2) left-hand running on a SW→NE alignment puts westbound trains on the SE track (the Bridge Street side), which is exactly where the survey places Platform 1 (the wide west end with the deep lift and the two escalators adjoins the Jubilee wells under Bridge Street) and where OSM's westbound way lies; (3) the TfL API platform coordinates are unlabelled approximate points and cannot support any numbering. The alternative is recorded in §14.
...
- **Platform length c. 130 m** (the 1962–64 extension was for 8-car trains of the CO/CP/R-stock era, c. 127–130 m; the later D78 Stock ran as 6 cars ≈ 109 m; 7-car S7 = 117.4 m, leaving c. 15–20 m of empty platform, mostly at the east end) `[estimate]`; rolling-stock estimate 130–140 m usable.
...
- 7-car trains, **total length 126.49 m (126.492 m; 415 ft 0 in)**. Current Wikipedia: driving motor (DM) **18.196 m**, trailer/UNDM **18.02 m**; older sources quote 17.77 m per car — **use c. 18.0–18.2 m for DMs and c. 17.8–18.0 m for intermediates**. **Width 2.629 m, height 2.875 m (rail to roof).**
- Formation **DM–T–UNDM + UNDM–ST–T–DM** (two 3-car units plus the 2005 'Special Trailer' 7th car, a ballasted unpowered trailer). Weights: DM 30.0 t, UNDM 27.1 t, T 20.9 t; train 176.9 t. 63 trains (441 cars), built 1995–98 by GEC Alsthom Metro-Cammell at Washwood Heath, Birmingham (bodyshells imported from Spain); the 2005 seventh cars by Alstom, Barcelona; 7-car since Dec 2005. **234 seats, c. 875 total capacity.**
...
2. Braking into Westminster / doors opening — two recorded variants:
   ...
   - **Verdict (revised by the fact-check pass):** default to **'This station is Westminster. Change here for the District and Circle lines.'** — 'This station is' / 'Change here for' is the verified Jubilee arrival format and the interchange clause is the part all three researchers agree on. 'District and Circle' ordering is the audio specialist's high-confidence recollection for the Drummond set (the alphabetical 'Circle and District' is the S7/Parnell convention; note the Drummond set IS alphabetical elsewhere, e.g. 'Bakerloo, Northern and Waterloo & City' at Waterloo, so treat the order as unconfirmed). The **'Exit here for the Houses of Parliament and Westminster Abbey.'** clause rests on a single memory: the 2005 Drummond set generally has no 'Exit for' clauses (those are a hallmark of the 2009–10 Parnell S-stock set), so ship it as an optional flag, **off by default**, until a recording confirms it. Ship all variants as switchable strings (see §14 #16, #18, #35).
...
**Rules:** the Jubilee DVA never says its own line name — it uses 'This train terminates at X', never 'This is a Jubilee line train to X' (the architecture researcher's 'This is a Jubilee line train to Stanmore' is therefore wrong and not to be used). (It is not quite unique in this: the Northern line's Drummond-era set uses the same 'This train terminates at X via Bank / via Charing Cross' style `[memory-medium]`; every other line says 'This is a … line train to X'.) Some 2016-era files added **'Doors will open on the left-hand side' / 'right-hand side'** at each station (YouTube, July 2016) — optional flavour, not consistently heard today.
...
- **Quarter past = change 1. Half past = changes 2, 3. Quarter to = changes 4, 5, 1. On the hour = changes 2, 3, 4, 5** — i.e. notes 5–20 of the once-repeating 20-note sequence; the quarter-past phrase (change 1) is never heard in the hour version. Strike counts: each change is 4 bell strikes, so quarter = 4, half = 8, three-quarter = 12, hour = 16 strikes; the audio researcher's text gave '5 / 10 / 15 / 20 notes' for the four phrases (counting each change as 5) — an internal inconsistency with the 20-note total, resolved here as 4 strikes per change `[verified]` against the Wikipedia change tables. **The B3 bell (the fourth quarter bell, 4 t) carries two hammers on opposite sides**, because in the third-quarter sequence (changes 4, 5, 1) and the hour sequence (2, 3, 4, 5) change 4 ends on B3 and change 5 begins on B3 — too quick for one hammer to reset. (An earlier draft said the E bell; that was wrong — no change strikes E twice in succession.) For synthesis: the B3 minim that closes change 4 is immediately followed by the B3 crotchet that opens change 5, so the same bell sounds twice c. 2 s apart.
...
- **Bus stops (OSM NaPTAN)** `[verified]`: **Stop H 'Westminster Station / Westminster Pier' at 51.50102, −0.12524 — north kerb of Bridge Street directly in front of Portcullis House, 24 m WEST of the entrance** (eastbound toward the bridge/Waterloo), no shelter, flag on a pole; Stop G 'Westminster Station / Parliament Square' at 51.50153, −0.12598 (east footway of Parliament Street, 50 m north of the corner, southbound, shelter + bench); Stop A (51.50182, −0.12631, shelter + bench) and Stop C (51.50156, −0.12635, no shelter) on the west footway of Parliament Street (northbound toward Trafalgar Square); Stop F (51.50247, −0.12590) further north on the east side; Stop P 'Parliament Square / Westminster Abbey' at 51.50018, −0.12681; 'Westminster Pier' stop at 51.50162, −0.12390 on the river side of the Embankment (northbound, shelter + bench). Bus flag: white flag with red roundel and black stop letter on a grey pole; shelters standard TfL grey steel-and-glass with red roundel. Routes `[verified — TfL Unified API StopPoint query, 4 Sep 2026]`: **Stop H (Bridge Street, in front of Portcullis House, towards Waterloo / Lambeth North): route 11 only.** Stop G (Parliament Street east side, southbound towards Kennington / Elephant & Castle, then over Westminster Bridge): **12, 159, 453** + N53, N109, N155, N381. Stop A (Parliament Street west side, northbound towards Aldwych / Piccadilly Circus): **12, 24, 26, 87, 88, 159, 453** + N3, N11, N26, N44, N53, N87, N109, N136, N155, N381. Stop F (further north, east side, southbound towards Kennington / Vauxhall / Victoria): **24, 26, 87, 88** + N3, N11, N26, N44, N53, N87, N136. Stop C (west side, towards Tottenham Court Road) and the Embankment 'Westminster Pier' stop K currently list no day routes. Stop P (Parliament Square / Westminster Abbey, towards Hyde Park Corner / Sloane Square): **11, 148**. So the day routes seen crossing Westminster Bridge are **11, 12, 148, 159, 453**, and the Whitehall/Parliament Street routes are 12, 24, 26, 87, 88, 159, 453. The older memory list (3, 53, 211 etc.) is out of date — those routes no longer serve these stops.
...
Use the TfL screen set for signage (matches TfL's own artwork); the Pantone set gives a slightly darker print-like look. Jubilee grey rationale: the line was planned as the 'Fleet line' — named after the River Fleet, not a naval fleet — and shown in grey; on renaming for the Queen's 1977 Silver Jubilee the grey was read as silver. (Do not repeat the 'battleship grey' folk etymology.)
...
- **Way out (yellow):** on the standard TfL sign family, black Johnston Medium on Corporate Yellow (#FFD300 / Pantone 116) with a black arrow, as a full yellow panel or a yellow tab inset in a blue sign; lower-case 'out'. **Caveat for Westminster:** the 1999 JLE stations use their own dark sign family — black/very dark grey panels with white Johnston and 'Way out' in yellow lettering (this is what §12.5 records as photographed: 'Way out (yellow on black panels with arrow)'); use that style on the Jubilee levels and the box, and the yellow-panel style on the older D&C level `[memory-medium]`, see §14 #38. At numbered-exit stations each exit has a **number badge: a black square with a white numeral (side c. 1.2 × cap height) immediately after 'Way out'**, then the destination list in smaller black text, e.g. **'Way out [1] Westminster Pier, Victoria Embankment'**. Street-level stair heads carry blue panels with roundel + exit number. Memory variant: 'Way out – Houses of Parliament, Westminster Abbey, Whitehall' and 'Way out – Westminster Pier, London Eye' with white text on blue and yellow arrows.
...
7. **Signage and lighting as the realism glue.** Johnston-class font, procedural roundel from the SVG ratios, the standard TfL sign colours (blue direction, yellow 'Way out' with black exit-number badges, black platform numbers) plus line tabs on the D&C level and subways, and the JLE dark family (black panels, white text, yellow 'Way out') on the Jubilee levels and in the box (§12.4, §14 #38); the photographed wordings of §12.5; platform numbers 1 W D&C, 2 E D&C, 3 E Jubilee upper, 4 W Jubilee lower; Exit 1 Westminster Pier, 2 Victoria Embankment, 3 Houses of Parliament, 4 Bridge Street, 5/6 Whitehall/Parliament Street. Amber DMIs with the 3-row 'n Destination  m min' layout and HH:MM:SS clock. Small repeated details: blue help points with green/red buttons, red extinguisher pairs, green running-man signs, dome CCTV, no platform bins, stainless benches and speakers, scuffed yellow paint and grime gradients at hand height.
...
|---|---|---|---|
| 1 | **D&C platform numbering** | Architecture (survey + photographed sign): P1 = westbound (SE side), P2 = eastbound. Audio (guess) and signage (inferred from API coordinates): P1 = eastbound (north track), P2 = westbound. | **P1 westbound / P2 eastbound.** Photograph + survey + left-hand-running geometry, now corroborated by OSM platform ways (ref 1 'Westbound', ref 2 'Eastbound', 4 Sep 2026); the API points turned out to be unlabelled, so the contrary inference had no basis. Treat as settled. |
| 2 | Jubilee platform numbering | Audio researcher guessed 3 = westbound upper, 4 = eastbound lower. All others: 3 = eastbound upper, 4 = westbound lower (photographed signs, live boards). | **3 eastbound (upper), 4 westbound (lower).** Confirmed by the TfL Arrivals feed ('Eastbound - Platform 3' / 'Westbound - Platform 4'), Wikipedia and OSM (4 Sep 2026). Settled. |
...
| 16 | **Jubilee arrival wording** | 'This is Westminster. Change for the District and Circle lines. Exit for…' (audio) vs 'This station is Westminster. Change here for the Circle and District lines. This train terminates at Stratford' (rolling-stock, ilyabirman format) vs 'This is Westminster. Change here for the Circle and District lines' (architecture). | Default (revised 4 Sep 2026): 'This station is Westminster. Change here for the District and Circle lines.' — exit clause optional and off by default (see #35); all variants shipped as switchable strings; confirm from a recording. |
...
| 29 | Bus routes | Route lists were memory-medium. | **Resolved 4 Sep 2026** from the TfL API — see §11.11 (Stop H = route 11 only; 12/159/453 at Stop G; 24/26/87/88 at Stop F). |
...
| 35 | **Jubilee arrival 'Exit here for…' clause** | Only the audio researcher recalls an exit clause on the Jubilee at Westminster; the 2005 Drummond set otherwise has no 'Exit for' phrases (those are the 2009–10 Parnell S-stock idiom). Also unresolved: whether the Drummond file says 'District and Circle' or the alphabetical 'Circle and District' (her set is alphabetical at Waterloo and Baker Street). | Default: 'This station is Westminster. Change here for the District and Circle lines.' with the exit clause OFF; confirm both points from a recording (fact-check pass, 4 Sep 2026, could not reach an announcement catalogue — web search quota exhausted). |
| 36 | 1996 Stock cab-front colours | 'Blue panels flanking a red M door' is memory-medium; the outwardly identical 1995 Stock is generally remembered as all-red at the front. | Check a Commons photo of a 1996 Stock cab front before texturing; do not rely on the blue cheeks. |
| 37 | Exits 4–6 numbering | OSM (re-queried 4 Sep 2026) carries ref=1 and ref=2 only on the two Embankment-corner nodes (587959213, 12793161797); no refs on the Parliament Street, south-side or Portcullis House nodes; the TfL station page could not be fetched (HTTP 403). | Exits 1–3 are photographed; 4 (Bridge Street), 5 (Whitehall east) and 6 (Parliament Street west) remain survey-based — confirm from a current in-station 'Way out' sign photo. |
| 38 | Sign colour family at Westminster | Standard TfL 'Way out' = black on yellow vs the JLE dark-panel family (white text, yellow 'Way out' on black) photographed here. | Use the JLE dark family on the Jubilee levels, standard family on the D&C level and subways; verify from photos. |
| 39 | Northern line DVA style | Claim that the Jubilee is the *only* line not naming itself was softened: the Northern's Drummond-era set is remembered as 'This train terminates at X via Bank' (memory-medium). | Irrelevant to the Westminster build; noted so nobody re-inserts 'only'. |
| 40 | Big Ben hour-stroke spacing | 'Every 4.5 s' is quoted from a secondary source; Wikipedia confirms only that the quarter chime begins 25 s before the first hour stroke. | Keep 4.5 s ± 0.5 s; tune to a recording. |
